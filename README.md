...
<h3 align="left">고등학생 개발자 · 아이디어를 코드로 만드는 중</h3>

- 🔭 Built a real-time hand gesture controller for macOS presentations using MediaPipe HandLandmarker & OpenCV
- 🌱 배우고 있는 것: **Python · C · HTML/CSS**
- 💡 최근 프로젝트: **손 제스처로 PPT 제어하기** (`ppt-gesture`)
- 🎨 디자인도 좋아해요 — Illustrator, Photoshop
...
<p><img align="left" src="https://github-readme-stats.vercel.app/api/top-langs?username=a1eph-zero&show_icons=true&locale=en&layout=compact" alt="a1eph-zero" /></p>
